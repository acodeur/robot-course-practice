...
def main():
    ...
    # soccer_practice_field.png, color_ball_clean.png, color_ball_floor_bg.png, soccer_grass.png, soccer_indoor_floor.png, soccer_studio_closeup.png
    image_path = base_dir / "images/soccer_indoor_floor.png"
