...
function leju_5171a1b67e32bb2e7d125bfc8a62f038()
 ...
 -- play_识别到的数字是9
function leju_6756aa6c2af83a1100f8428837910bc7()
	Play_AI_music("0:/music/识别到的数字是9.mp3")
end

 -- play_0
function leju_af4a97dac1040ee9e27bc073f65924f3()
	Play_AI_music("0:/music/0.mp3")
end
...
function leju_6a9aed7257533dfe41469501c6e5163d()
 ...
 -- play_当前距离为
function leju_11d2d4ee8e0058ba56f0ba036caa8598()
	Play_AI_music("0:/music/当前距离为.mp3")
end

 -- play_当前顺序为
function leju_1eb54c9f2d01b1cba9ef014c9e02e86c()
	Play_AI_music("0:/music/当前顺序为.mp3")
end
...
function leju_d105152d415451275cbf6dac5cc00c5f()
 ...
 -- play_欢迎光临
function leju_ed8c1653000c23001881dac5a36fcc4a()
	Play_AI_music("0:/music/欢迎光临.mp3")
end

 -- play_厘米
function leju_4532ac2abf0b3f3e362de5541028e45d()
	Play_AI_music("0:/music/厘米.mp3")
end

 -- play_你好，我是小爱
function leju_5716f0aaeac91fb447fd1a3105a9f2db()
	Play_AI_music("0:/music/你好，我是小爱.mp3")
end

 -- play_识别到的数字是0
function leju_46d9c3b4e66b573525814c0cf0b7b681()
	Play_AI_music("0:/music/识别到的数字是0.mp3")
end

 -- play_识别到的数字是1
function leju_9c7709c6bdf3232065fd4ef36d462102()
	Play_AI_music("0:/music/识别到的数字是1.mp3")
end

 -- play_识别到的数字是2
function leju_751a7d614b315b217acee9a7336c7b48()
	Play_AI_music("0:/music/识别到的数字是2.mp3")
end

 -- play_识别到的数字是3
function leju_4cdd27cb116fb34436a9256b52ed1b31()
	Play_AI_music("0:/music/识别到的数字是3.mp3")
end

 -- play_识别到的数字是4
function leju_4753f509d36e971e14c750b6f869878d()
	Play_AI_music("0:/music/识别到的数字是4.mp3")
end

 -- play_识别到的数字是5
function leju_90d731bd15f5b4c86614be20b4fe0788()
	Play_AI_music("0:/music/识别到的数字是5.mp3")
end

 -- play_识别到的数字是6
function leju_363fe3e389642a94bbc7160471731376()
	Play_AI_music("0:/music/识别到的数字是6.mp3")
end

 -- play_识别到的数字是7
function leju_a9b68ff0df87d5b0bb49758874577ea8()
	Play_AI_music("0:/music/识别到的数字是7.mp3")
end

 -- play_识别到的数字是8
function leju_64bb14c55fe4b63d48762b057ad05e3e()
	Play_AI_music("0:/music/识别到的数字是8.mp3")
end

 -- play_你现在打不倒我了
function leju_f970b626c9a19a99db37a2e28cd993be()
	Play_AI_music("0:/music/你现在打不倒我了.mp3")
end
